...
architecture user_logic_arch of user_logic is
  ...
  signal slv_reg2                       : std_logic_vector(0 to C_SLV_DWIDTH-1); -- array_S
  signal slv_reg3                       : std_logic_vector(0 to C_SLV_DWIDTH-1); -- size
  ...
  signal array_S_sig : std_logic_vector (31 downto 0);
  signal size_sig : signed (31 downto 0);
  ...
  component coreA is
   port(
      ...
      array_S : in std_logic_vector (31 downto 0);
      size : in signed (31 downto 0);
  ...
  -- implement slave model software accessible register(s)
    ...
    array_S_sig <= slv_reg2;
    size_sig <= signed(slv_reg3);
    -- Return Port
