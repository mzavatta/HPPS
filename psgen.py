...
def importgenerics():
	...
	print "Importing generic information from XML"
...
def connect(link, components, globalports):
	...
	if src_isGlobalPort and not tgt_isGlobalPort: 
		...
		# the case in which we are connecting something to a bus component's port (e.g. clock) is
		# redirected to a simple port to port connection
...
def importmssdefaults():
		...
		print "Importing MSS defaults settings..."
		...
		print "Done, imported MSS defaults settings!"
...
def printxmp(swprojs):
	...
	# clean swprojs
	print "Done! XMP printed"
	logoutputHandle.write("Done! XMP printed\n")
...
def printall():
	...
	logoutputHandle.write("\nPrinting imported architecture on "+mhsoutput+"\n")
	print "Printing imported architecture on "+mhsoutput+"\n"
...
print "------------------------\n"
print "Files handled:"
print "Output MHS file printed in: "+mhsoutput
print "Output MSS file printed in: "+mssoutput
print "Output XMP file printed in: "+xmpoutput

print "Architecture's XML description expected in: "+xmlinput
print "Default MHS settings expected in: "+mhsdefaultsFile
print "Default MSS settings expected in: "+mssdefaultsFile
print "Default XMP settings expected in: "+xmpdefaultsFile
print "EDK IP cores "'hw'" directory expected in: "+hwIPbasepath
print "Custom IPs "'pcores'" directory expected in: "+customIPbasepath

print "\nLOG printed in: "+logoutput+"\n"

## Import generic parameters like device code, project name etc..
importgenerics()

print "Importing components and global ports.."
